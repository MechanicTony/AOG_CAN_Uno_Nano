//*******************************************
//Claas Demo AC Curve Command Generator
//
...
byte data1[8] = {4, 0, 125, 0, 0, 0, 0, 0} ;      //Engage Data         
...
if (steerState == 1) steerState = 16; // 16 Or 20 = OK
  ...
  if ((millis() - scanLoopMs) > scanLoopInterval) {   // Send data
    ...
    data[6] = 255;
    data[7] = 255;
    CAN0.sendMsgBuf(0x8CAC1E13, 1, 8, data);

  engageState = digitalRead(engageButton);

if(engageState == 0) CAN0.sendMsgBuf(0x18EF1CD2, 1, 8, data1);
